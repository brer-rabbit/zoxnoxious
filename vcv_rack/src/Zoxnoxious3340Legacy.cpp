...
struct Zoxnoxious3340Legacy : ZoxnoxiousModule {
    ...
    void processZoxnoxiousControl(ZoxnoxiousControlMsg *controlMsg) override {
        ...
        controlMsg->frame[outputDeviceId].samples[cvChannelOffset + 1] = clamp(v, 0.f, 1.f);
        ...
        controlMsg->frame[outputDeviceId].samples[cvChannelOffset + 0] = clamp(v, 0.f, 1.f);
        if (controlMsg->frame[outputDeviceId].samples[cvChannelOffset + 0] != v) {
...
struct Zoxnoxious3340LegacyWidget : ModuleWidget {

    Zoxnoxious3340LegacyWidget(Zoxnoxious3340Legacy* module) {
        setModule(module);
        setPanel(createPanel(asset::plugin(pluginInstance, "res/Zoxnoxious3340_legacy.svg")));
        ...
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(9.7834, 24.553)), module, Zoxnoxious3340Legacy::FREQ_KNOB_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(43.275, 24.553)), module, Zoxnoxious3340Legacy::PULSE_WIDTH_KNOB_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(27.020, 24.553)), module, Zoxnoxious3340Legacy::LINEAR_KNOB_PARAM));

        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(62.243, 27.700)), module, Zoxnoxious3340Legacy::MIX1_PULSE_BUTTON_PARAM, Zoxnoxious3340Legacy::MIX1_PULSE_BUTTON_LIGHT));

        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(62.313, 41.912)), module, Zoxnoxious3340Legacy::MIX1_TRIANGLE_KNOB_PARAM));

        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(39.480, 87.501)), module, Zoxnoxious3340Legacy::SYNC_PHASE_KNOB_PARAM));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(33.559, 72.994)), module, Zoxnoxious3340Legacy::SYNC_POS_BUTTON_PARAM, Zoxnoxious3340Legacy::SYNC_POS_ENABLE_LIGHT));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(45.19, 72.995)), module, Zoxnoxious3340Legacy::SYNC_NEG_BUTTON_PARAM, Zoxnoxious3340Legacy::SYNC_NEG_ENABLE_LIGHT));


        addParam(createParamCentered<RoundBlackSnapKnob>(mm2px(Vec(62.487, 69.011)), module, Zoxnoxious3340Legacy::MIX1_SAW_LEVEL_SELECTOR_PARAM));

        addParam(createLightParamCentered<VCVLightButton<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(21.625, 63.689)), module, Zoxnoxious3340Legacy::EXT_MOD_SELECT_SWITCH_UP_PARAM, Zoxnoxious3340Legacy::EXT_MOD_SELECT_SWITCH_UP_LIGHT));
        addParam(createLightParamCentered<VCVLightButton<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(9.994, 63.689)), module, Zoxnoxious3340Legacy::EXT_MOD_SELECT_SWITCH_DOWN_PARAM, Zoxnoxious3340Legacy::EXT_MOD_SELECT_SWITCH_DOWN_LIGHT));

        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(62.487, 87.388)), module, Zoxnoxious3340Legacy::MIX1_COMPARATOR_BUTTON_PARAM, Zoxnoxious3340Legacy::MIX1_COMPARATOR_BUTTON_LIGHT));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(14.184, 87.501)), module, Zoxnoxious3340Legacy::EXT_MOD_AMOUNT_KNOB_PARAM));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(57.112, 118.52)), module, Zoxnoxious3340Legacy::MIX2_PULSE_BUTTON_PARAM, Zoxnoxious3340Legacy::MIX2_PULSE_BUTTON_LIGHT));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(10.626, 118.52)), module, Zoxnoxious3340Legacy::EXT_MOD_PWM_BUTTON_PARAM, Zoxnoxious3340Legacy::EXT_MOD_PWM_BUTTON_LIGHT));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(26.663, 118.52)), module, Zoxnoxious3340Legacy::EXP_FM_BUTTON_PARAM, Zoxnoxious3340Legacy::EXP_FM_BUTTON_LIGHT));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(43.275, 118.52)), module, Zoxnoxious3340Legacy::LINEAR_FM_BUTTON_PARAM, Zoxnoxious3340Legacy::LINEAR_FM_BUTTON_LIGHT));
        addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<WhiteLight>>>(mm2px(Vec(68.019, 118.52)), module, Zoxnoxious3340Legacy::MIX2_SAW_BUTTON_PARAM, Zoxnoxious3340Legacy::MIX2_SAW_BUTTON_LIGHT));

        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(9.7834, 37.915)), module, Zoxnoxious3340Legacy::FREQ_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(43.275, 37.915)), module, Zoxnoxious3340Legacy::PULSE_WIDTH_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(27.020, 37.915)), module, Zoxnoxious3340Legacy::LINEAR_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(62.314, 53.955)), module, Zoxnoxious3340Legacy::MIX1_TRIANGLE_VCA_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(39.480, 101.925)), module, Zoxnoxious3340Legacy::SYNC_PHASE_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(14.184, 101.924)), module, Zoxnoxious3340Legacy::EXT_MOD_AMOUNT_INPUT));

        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(13.783, 30.553)), module, Zoxnoxious3340Legacy::FREQ_CLIP_LIGHT));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(47.793, 30.553)), module, Zoxnoxious3340Legacy::PULSE_WIDTH_CLIP_LIGHT));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(31.020, 30.553)), module, Zoxnoxious3340Legacy::LINEAR_CLIP_LIGHT));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(66.313, 47.912)), module, Zoxnoxious3340Legacy::MIX1_TRIANGLE_VCA_CLIP_LIGHT));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(43.480, 93.501)), module, Zoxnoxious3340Legacy::SYNC_PHASE_CLIP_LIGHT));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(18.184, 93.501)), module, Zoxnoxious3340Legacy::EXT_MOD_AMOUNT_CLIP_LIGHT));

        addChild(createLightCentered<TriangleLeftLight<SmallLight<RedGreenBlueLight>>>(mm2px(Vec(2.020, 8.2185)), module, Zoxnoxious3340Legacy::LEFT_EXPANDER_LIGHT));
        addChild(createLightCentered<TriangleRightLight<SmallLight<RedGreenBlueLight>>>(mm2px(Vec(74.427, 8.219)), module, Zoxnoxious3340Legacy::RIGHT_EXPANDER_LIGHT));
...
Model* modelZoxnoxious3340Legacy = createModel<Zoxnoxious3340Legacy, Zoxnoxious3340LegacyWidget>("Zoxnoxious3340Legacy");
