...
struct AudioIO final : rack::engine::Module {
  ...
  enum LightId {
    ...
    ENUMS(CARD_A_PATCH_USAGE_LIGHT, 3),
    ENUMS(CARD_B_PATCH_USAGE_LIGHT, 3),
    ENUMS(CARD_C_PATCH_USAGE_LIGHT, 3),
    ENUMS(CARD_D_PATCH_USAGE_LIGHT, 3),
    ENUMS(CARD_E_PATCH_USAGE_LIGHT, 3),
    ENUMS(CARD_F_PATCH_USAGE_LIGHT, 3),
