...
// reg, reg addr,   or-mask,    and-mask
  { 1, port1_addr, 0b00000000, 0b10111111 }, // prog 0 - card A mix1 off
  { 1, port1_addr, 0b01000000, 0b11111111 }, // prog 1 - card A mix1 on
  { 1, port1_addr, 0b00000000, 0b01111111 }, // prog 2 - card B mix1 off 
  { 1, port1_addr, 0b10000000, 0b11111111 }, // prog 3 - card B mix1 on  
  { 1, port1_addr, 0b00000000, 0b11101111 }, // prog 4 - card C mix1 off
  { 1, port1_addr, 0b00010000, 0b11111111 }, // prog 5 - card C mix1 on 
  { 1, port1_addr, 0b00000000, 0b11011111 }, // prog 6 - card D mix1 off
  { 1, port1_addr, 0b00100000, 0b11111111 }, // prog 7 - card D mix1 on  
  ...
  { 1, port1_addr, 0b00000000, 0b11111110 }, // prog 12 - card A mix2 off
  { 1, port1_addr, 0b00000001, 0b11111111 }, // prog 13 - card A mix2 on
  { 1, port1_addr, 0b00000000, 0b11111101 }, // prog 14 - card B mix2 off 
  { 1, port1_addr, 0b10000010, 0b11111111 }, // prog 15 - card B mix2 on  
  { 1, port1_addr, 0b00000000, 0b11111011 }, // prog 16 - card C mix2 off
  { 1, port1_addr, 0b00000100, 0b11111111 }, // prog 17 - card C mix2 on 
  { 1, port1_addr, 0b00000000, 0b11110111 }, // prog 18 - card D mix2 off
  { 1, port1_addr, 0b00001000, 0b11111111 }, // prog 19 - card D mix2 on  
  { 0, port0_addr, 0b00000000, 0b11111011 }, // prog 20 - card E mix2 off
  { 0, port0_addr, 0b00000100, 0b11111111 }, // prog 21 - card E mix2 on  
  { 0, port0_addr, 0b00000000, 0b11110111 }, // prog 22 - card F mix2 off
  { 0, port0_addr, 0b00001000, 0b11111111 }  // prog 23 - card F mix2 on
};
